...
export default {
  createItem: async (newItem: SewingLine, accessToken: string): Promise<ResponseDataType> => {
    return await client
      .post(
        `${NAMESPACE}`,
        {
  ...
  updateItemByPk: async (id: number, itemToUpdate: SewingLine, accessToken: string): Promise<ResponseDataType> => {
    return client
